...
export class RemoveLabelByOwnerRequest extends jspb.Message {
  getId(): number;
  setId(value: number): void;
  ...
  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): RemoveLabelByOwnerRequest.AsObject;
  static toObject(includeInstance: boolean, msg: RemoveLabelByOwnerRequest): RemoveLabelByOwnerRequest.AsObject;
  static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
  static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
  static serializeBinaryToWriter(message: RemoveLabelByOwnerRequest, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): RemoveLabelByOwnerRequest;
  static deserializeBinaryFromReader(message: RemoveLabelByOwnerRequest, reader: jspb.BinaryReader): RemoveLabelByOwnerRequest;
}

export namespace RemoveLabelByOwnerRequest {
  export type AsObject = {
    id: number,
    owner: number,
  }
...
export class RemoveLabelByOwnerResponse extends jspb.Message {
  getState(): StateMap[keyof StateMap];
  setState(value: StateMap[keyof StateMap]): void;
  ...
  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): RemoveLabelByOwnerResponse.AsObject;
  static toObject(includeInstance: boolean, msg: RemoveLabelByOwnerResponse): RemoveLabelByOwnerResponse.AsObject;
  static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
  static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
  static serializeBinaryToWriter(message: RemoveLabelByOwnerResponse, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): RemoveLabelByOwnerResponse;
  static deserializeBinaryFromReader(message: RemoveLabelByOwnerResponse, reader: jspb.BinaryReader): RemoveLabelByOwnerResponse;
}

export namespace RemoveLabelByOwnerResponse {
  export type AsObject = {
    state: StateMap[keyof StateMap],
    message: string,
  }
