...
type PermissionServiceClient interface {
	...
	DeleteResources(ctx context.Context, in *DeleteResourcesRequest, opts ...grpc.CallOption) (*DeleteResourcesResponse, error)
...
type PermissionServiceServer interface {
	...
	DeleteResources(context.Context, *DeleteResourcesRequest) (*DeleteResourcesResponse, error)
...
func (UnimplementedPermissionServiceServer) DeleteResources(context.Context, *DeleteResourcesRequest) (*DeleteResourcesResponse, error) {
...
func _PermissionService_DeleteResources_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(DeleteResourcesRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PermissionServiceServer).DeleteResources(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
...
var PermissionService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _PermissionService_DeleteResources_Handler,
		},
		{
